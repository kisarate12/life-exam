      ...
      <main className="mx-auto max-w-2xl px-4 py-12">
        <div className="card-rpg p-8">
          ...
          >
            ...
            <div className="flex flex-col-reverse flex-wrap items-stretch gap-3 pt-4 md:flex-row md:flex-nowrap md:items-center md:justify-between">
              {currentIndex > 0 ? (
                <Link
              ...
              <button
                type="submit"
                disabled={submitting}
                className="btn-rpg-main order-1 md:order-2 md:ml-auto"
              >
                {submitting
                  ? "送信中..."
                  : isLastSubject
